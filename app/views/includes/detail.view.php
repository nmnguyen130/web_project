...
<div class="d-flex justify-content-center btn-container hidden">
    <button class="btn btn-secondary mx-2 my-2 custom-btn animal-btn">Động Vật</button>
    <button class="btn btn-primary mx-2 my-2 custom-btn plant-btn">Thực Vật</button>
</div>